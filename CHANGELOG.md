...
- Recompiled plugin with Go version `1.24`. ([#91](https://github.com/turbot/steampipe-plugin-googleworkspace/pull/91))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#95](https://github.com/turbot/steampipe-plugin-googleworkspace/pull/95))
...
- Recompiled plugin with Go version `1.23.1`. ([#84](https://github.com/turbot/steampipe-plugin-googleworkspace/pull/84))
- Recompiled plugin with [steampipe-plugin-sdk v5.11.5](https://github.com/turbot/steampipe-plugin-sdk/blob/v5.11.5/CHANGELOG.md#v5115-2025-03-31) that addresses critical and high vulnerabilities in dependent packages. ([#84](https://github.com/turbot/steampipe-plugin-googleworkspace/pull/84))
